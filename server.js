...
===================================== */
mongoose.connect("mongodb://mongo:27017/techbamboo")
...
===================================== */
app.post("/submit-request", upload.single("referenceImage"), async (req, res) => {
    try {
...
app.listen(PORT, "0.0.0.0", () => {
    console.log(`TechBamboo running at http://localhost:${PORT}`);
});